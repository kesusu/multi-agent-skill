...
| 理论研究 | AI×生态位×注意力框架，4 轮从学术到行动指南                  | 理论家写框架、场景测试员发现文科生入口缺失 → [`demos/theory_v3.3建议看另外一个更好的版本.md`](demos/theory_v3.3建议看另外一个更好的版本.md) |
...
└── demos/
    ...
    ├── theory_v3.3_CS OR EE.md # 理论文档 CS/EE 版（理论家+研究员+批评家+验收者+场景测试员）
    └── theory_v3.3建议看另外一个更好的版本.md  # 理论文档通用版（理论家+研究员+批评家+验收者+场景测试员，4轮迭代）
```
